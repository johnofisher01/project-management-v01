...
import { Link, Search, Settings, Menu, Sun, Moon } from "lucide-react";
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="relative flex h-min w-[200px]">
          ...
          <input
            type="search"
            placeholder="Search.."
            className="dark w-full rounded border-none bg-gray-100 p-2 pl-8 placeholder-gray-500 focus:border-transparent focus:outline-none dark:bg-gray-700 dark:text-white"
          />
        </div>
      </div>
